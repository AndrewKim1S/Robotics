...
void Robot::AutonomousPeriodic() {
  if(Auto_timer.Get() > 0 && Auto_timer.Get() < 2){
    _shooter.setState(Shoot::State::Aiming);
  }
  else if(Auto_timer.Get() > 2 && Auto_timer.Get() < 3){
    _channel.setState(Channel::State::Shooting);
    _shooter.setState(Shoot::State::Aiming);
  }
  else if(Auto_timer.Get() > 3 && Auto_timer.Get() < 4) {
...
//     _drivetrain.Auto();
//   } 
//   else if(Auto_timer.Get() > 6 && Auto_timer.Get() < 9){
//     _shooter.setState(Shoot::State::Aiming);
//     //_shooter.Aim(navx->GetYaw());
//   }
//   else if(Auto_timer.Get() > 9 && Auto_timer.Get() < 11){
//     _shooter.setState(Shoot::State::Aiming);
//     _channel.setState(Channel::State::Shooting);
//   }
